...
#define MBED_CONF_APP_HOSTNAME                                                  "192.168.0.18"                                                                                   // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                   "13172631"                                                                                       // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                   WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                       "0106"                                                                                           // set by application[*]
